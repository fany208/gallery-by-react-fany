...
var GallerByReactFanyApp = React.createClass({
...
React.render(<GallerByReactFanyApp />, document.getElementById('content')); // jshint ignore:line

module.exports = GallerByReactFanyApp;
